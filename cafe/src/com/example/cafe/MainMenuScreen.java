...
public class MainMenuScreen extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		btn_cafe.setOnClickListener(new Button.OnClickListener() 
		{
			...
			{
				Intent intent_add = new Intent(MainMenuScreen.this, CafeScreen.class);
		...
		btn_profile.setOnClickListener(new Button.OnClickListener() 
		{
			public void onClick(View v) 
			{
				Intent intent_add = new Intent(MainMenuScreen.this, ProfileScreen.class);
				startActivity(intent_add);
			}
		});
		...
		btn_mail.setOnClickListener(new Button.OnClickListener() 
		{
			public void onClick(View v) 
			{
				Intent intent_add = new Intent(MainMenuScreen.this, MailScreen.class);
				startActivity(intent_add);
			}
		});
		...
		btn_friend.setOnClickListener(new Button.OnClickListener() 
		{
			public void onClick(View v) 
			{
				Intent intent_add = new Intent(MainMenuScreen.this, FriendScreen.class);
				startActivity(intent_add);
			}
		});
