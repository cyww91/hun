	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		//카페 찾기 버튼
				btn_cafe.setOnClickListener(new Button.OnClickListener() 
				{
					...
					{
						Intent intent_add = new Intent(FriendScreen.this, CafeScreen.class);
				...
				btn_profile.setOnClickListener(new Button.OnClickListener() 
				{
					public void onClick(View v) 
					{
						Intent intent_add = new Intent(FriendScreen.this, ProfileScreen.class);
						startActivity(intent_add);
						finish();
					}
				});
				...
				btn_mail.setOnClickListener(new Button.OnClickListener() 
				{
					public void onClick(View v) 
					{
						Intent intent_add = new Intent(FriendScreen.this, MailScreen.class);
						startActivity(intent_add);
						finish();
					}
				});
				...
				btn_setting.setOnClickListener(new Button.OnClickListener() 
				{
					public void onClick(View v) 
					{
						Intent intent_add = new Intent(FriendScreen.this, SettingScreen.class);
						startActivity(intent_add);
						finish();
					}
				});
